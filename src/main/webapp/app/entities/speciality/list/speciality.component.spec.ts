...
describe('Speciality Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'speciality', component: SpecialityComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.specialities?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
