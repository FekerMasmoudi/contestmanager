...
describe('Contest Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('Should call Educationlevel query and add missing value', () => {
      const contest: IContest = { id: 'CBA' };
      const ideducationlevel: IEducationlevel = { id: '13d0a45c-84e7-43ed-8942-c1e77eb4d1db' };
      contest.ideducationlevel = ideducationlevel;

      const educationlevelCollection: IEducationlevel[] = [{ id: 'd293adc7-1860-48b5-bc5a-985144b666aa' }];
    ...
    it('Should update editForm', () => {
      ...
      contest.idsector = idsector;
      const ideducationlevel: IEducationlevel = { id: 'fefe7a7a-23aa-46ac-81c1-5053e9aa5e38' };
      contest.ideducationlevel = ideducationlevel;
