...
import { EntityArrayResponseType, EducationlevelService } from '../service/educationlevel.service';
...
export class EducationlevelComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEducationlevel): string => this.educationlevelService.getEducationlevelIdentifier(item);
