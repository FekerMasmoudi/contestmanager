...
describe('Educationlevel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'educationlevel', component: EducationlevelComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.educationlevels?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
