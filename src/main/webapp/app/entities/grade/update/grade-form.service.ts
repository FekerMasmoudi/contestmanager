...
type GradeFormGroupContent = {
  ...
  ideducationlevel: FormControl<IGrade['ideducationlevel']>;
  idcertificate: FormControl<IGrade['idcertificate']>;
};
...
export class GradeFormService {
  createGradeFormGroup(grade: GradeFormGroupInput = { id: null }): GradeFormGroup {
    ...
    return new FormGroup<GradeFormGroupContent>({
      ...
      ideducationlevel: new FormControl(gradeRawValue.ideducationlevel),
      idcertificate: new FormControl(gradeRawValue.idcertificate),
    });
  }
