...
export class CertificateRoutingResolveService implements Resolve<ICertificate | null> {
  constructor(protected service: CertificateService, protected router: Router) {}

  resolve(route: ActivatedRouteSnapshot): Observable<ICertificate | null | never> {
