...
public class CertificateResource {
    ...
    public ResponseEntity<CertificateDTO> updateCertificate(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, certificateDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<CertificateDTO> partialUpdateCertificate(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, certificateDTO.getId())
        );
    }
