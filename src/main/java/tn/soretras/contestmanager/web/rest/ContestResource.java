...
public class ContestResource {
    ...
    public ResponseEntity<ContestDTO> updateContest(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contestDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ContestDTO> partialUpdateContest(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contestDTO.getId())
        );
    }
