...
public class ContestformResource {
    ...
    public ResponseEntity<ContestformDTO> updateContestform(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contestformDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ContestformDTO> partialUpdateContestform(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, contestformDTO.getId())
        );
    }
