...
class GeneralrulesResourceIT {
    ...
    public static Generalrules createEntity() {
        Generalrules generalrules = new Generalrules().designation(DEFAULT_DESIGNATION);
        return generalrules;
    }
    ...
    public static Generalrules createUpdatedEntity() {
        Generalrules generalrules = new Generalrules().designation(UPDATED_DESIGNATION);
        return generalrules;
    }
    ...
    void putExistingGeneralrules() throws Exception {
        ...
        updatedGeneralrules.designation(UPDATED_DESIGNATION);
    ...
    void fullUpdateGeneralrulesWithPatch() throws Exception {
        ...
        partialUpdatedGeneralrules.designation(UPDATED_DESIGNATION);
