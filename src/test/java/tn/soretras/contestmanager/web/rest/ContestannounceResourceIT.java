...
class ContestannounceResourceIT {
    ...
    public static Contestannounce createEntity() {
        ...
        contestannounce.setIdsgeneralrules(generalrules);
    ...
    void putExistingContestannounce() throws Exception {
        ...
        updatedContestannounce.announceText(UPDATED_ANNOUNCE_TEXT).startdate(UPDATED_STARTDATE).limitdate(UPDATED_LIMITDATE);
    ...
    void fullUpdateContestannounceWithPatch() throws Exception {
        ...
        partialUpdatedContestannounce.announceText(UPDATED_ANNOUNCE_TEXT).startdate(UPDATED_STARTDATE).limitdate(UPDATED_LIMITDATE);
